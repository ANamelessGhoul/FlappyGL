// malloc/free based on wasm-malloc by Max Klein at https://github.com/maxkl/wasm-malloc
// other std c functions based on musl libc at https://git.musl-libc.org/cgit/musl 


#ifdef PLATFORM_WEB_WASM
...
void *realloc(void *ptr, size_t size) {
	...
	if (!block_info_valid(block)) {
#ifdef MALLOC_DEBUG
		prints("realloc(): invalid pointer: ");
		printptr(ptr);
		printc('\n');
#endif
		return NULL;
